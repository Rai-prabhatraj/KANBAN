    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <div className="w-10 h-10 bg-gradient-to-br from-primary to-primary/70 rounded-xl flex items-center justify-center shadow-lg mr-3">
            <Settings className="h-5 w-5 text-primary-foreground" />
          </div>
          <div>
            <h3 className="text-xl font-bold text-foreground">Automation Rules</h3>
            <p className="text-sm text-muted-foreground">Automate your workflow with smart rules</p>
          </div>
        </div>
